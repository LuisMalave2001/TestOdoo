...
class Inquiry(models.Model):
    ...
    # grade_level = fields.Many2one("school_base.grade_level", string="Grade Level")
    ...
    def create(self, values):
        ...
        return super(Inquiry, self).create(values)
    ...
    def write(self, values):
        ...
        return super(Inquiry, self).write(values)
...
class InquiryTasks(models.Model):
    ...
    #status_ids = fields.Many2many("adm_uni.inquiry.status")
    # inquiry_ids = fields.Many2many("adm_uni.inquiry")
